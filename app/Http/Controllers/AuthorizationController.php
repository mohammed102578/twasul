...
class AuthorizationController extends Controller
{
        ...
        public function switchSeller()
    {
        ...
        session()->put('account_type', 'seller');
       
        $notify[] = ['success','Swicting to Seller Successful'];
       
        return back()->withNotify($notify);
    }
    public function switchBuyer(Request $request)
    {
        session()->put('account_type', 'buyer');
       
        $notify[] = ['success','Swicting to Buyer Successful'];
